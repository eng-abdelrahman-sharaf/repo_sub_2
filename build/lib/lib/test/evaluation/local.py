...
def local_env_settings():
    ...
    # prj_dir: 3 levels up from this file = site-packages/ (installed) or repo root (dev).
    # experiments/uetrack/*.yaml will be present in both cases.
    repo_sub_dir = os.path.abspath(os.path.join(here, "..", "..", ".."))
    # save_dir: where checkpoints/ lives — always the current working directory
    # (i.e. the submission directory from which inference.py is invoked).
